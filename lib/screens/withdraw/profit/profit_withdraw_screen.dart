// Profit_Withdraw_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:v1_micro_finance/configs/widgets/comon_appbar.dart';
import 'package:v1_micro_finance/screens/withdraw/profit/profit_withdraw_viewmodel.dart';

class ProfitWithdrawScreen extends StatelessWidget {
  const ProfitWithdrawScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 2,
      child: Scaffold(
        appBar: CommonAppBar(title: "Profit Withdraw"),
        body: Column(
          children: [
            const TabBar(
...
class BankWithdrawalForm extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final vm = context.watch<ProfitWithdrawViewmodel>();
    return Padding(
