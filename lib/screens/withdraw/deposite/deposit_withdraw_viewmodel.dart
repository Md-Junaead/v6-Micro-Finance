...
// class DepositWithdrawViewModel with ChangeNotifier {
...
//       final balanceId = prefs.getInt('balanceId');

//       if (token == null || userId == null || balanceId == null) {
//         throw Exception('Authentication required');
//       }

//       final response = await http.post(
//         Uri.parse('http://75.119.134.82:6160/api/transactions/save'),
//         headers: {
...
//           'dipositwithdrawamount':
//               double.parse(_bankControllers['amount']!.text),
...
//       // Add crypto type specific field
//       body[_cryptoData['type'].toLowerCase()] = _cryptoData['amount']!.text;

//       final response = await http.post(
//         Uri.parse('http://75.119.134.82:6160/api/withdraw/CryptoDeposit/save'),
//         headers: {
//           'Content-Type': 'application/json',
//           'Authorization': 'Bearer $token',
//         },
...
//       // Debugging auth data
//       debugPrint('Token: $token, User ID: $userId, Balance ID: $balanceId');
