class CryptoDepositWithdrawModel {
  final int id;
  ...
  factory CryptoDepositWithdrawModel.fromJson(Map<String, dynamic> json) {
    return CryptoDepositWithdrawModel(
      id: json['id'],
